...
-- Obtener la cantidad total de galones (anual) por cada acueducto en un anio especifico:
SELECT Año, 
...
-- Calcular la suma total de galones suministrados por todos los acueductos en un año específico:
